...
namespace WebAppForMORecSys.Migrations
{
    ...
    [Migration("20231030174050_NegativeExplanations")]
    partial class NegativeExplanations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebAppForMORecSys.Models.Metric", b =>
                {
                    ...
                    b.Property<string>("DefaultNegativeExplanation")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebAppForMORecSys.Models.MetricVariant", b =>
                {
                    ...
                    b.Property<string>("NegativeExplanation")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
