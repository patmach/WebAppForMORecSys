...
namespace WebAppForMORecSys.Migrations
{
    ...
    public partial class Reset : Migration
    {
        ...
        {/*
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HTTPUri = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SupportedCommunication = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Hyperparameters = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RecommenderSystemID = table.Column<int>(type: "int", nullable: false),
                    DefaultExplanation = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Metrics", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Metrics_RecommenderSystems_RecommenderSystemID",
                        column: x => x.RecommenderSystemID,
                        principalTable: "RecommenderSystems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Metrics_RecommenderSystemID",
                table: "Metrics",
