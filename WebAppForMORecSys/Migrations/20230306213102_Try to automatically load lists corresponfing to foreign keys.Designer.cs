...
namespace WebAppForMORecSys.Migrations
{
    ...
    [Migration("20230306213102_Try to automatically load lists corresponfing to foreign keys")]
    partial class Trytoautomaticallyloadlistscorresponfingtoforeignkeys
    {
        /// <inheritdoc />
