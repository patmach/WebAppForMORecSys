...
namespace WebAppForMORecSys.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserStore<Data.Account> _userStore;
        private readonly IUserEmailStore<Data.Account> _emailStore;
        private readonly ILogger<RegisterModel> _logger;
        private readonly IEmailSender _emailSender;

        public RegisterModel(
            UserManager<Data.Account> userManager,
            IUserStore<Data.Account> userStore,
            SignInManager<Data.Account> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _userStore.SetUserNameAsync(account, Input.UserName, CancellationToken.None);
                await _emailStore.SetEmailAsync(account, Input.Email, CancellationToken.None);
        ...
        private Data.Account CreateUser()
        {
            try
            {
                return Activator.CreateInstance<Data.Account>();
            }
            catch
            {
        ...
        private IUserEmailStore<Data.Account> GetEmailStore()
        {
